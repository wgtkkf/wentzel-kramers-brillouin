...
# gap
number = 1000 # [-], integral parameter, initial: 500
...
#Ef_gold = 0 # [eV], relative to the emitter fermi energy (Devon's Ph.D. thesis, P.36)
#Ef_gold = 5.51 eV, but treat as a reference. So set as zero.. this procedure..?
#Ef_L = Ef_gold
#Ef_R = Ef_gold
...
Ezmin = -3 # [eV], integral lower: change here, depends on condition
#Ezmin = wz_total(gapmin) # [eV], integral upper: change here, depends on condition
...
while Ez < Ezmax: # [eV]
    ...
    JTE = JL(Ezmax)-JR(Ezmax-volt) # [A/m2]
...
# output
f4.write('nm V W/cm2 W/cm2 A/cm2 A/cm2 nW/K nW/K')
f4.write('\n')
